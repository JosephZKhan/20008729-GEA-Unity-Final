Shader "Custom/RDSurface"
{
    Properties
    {
        ...
        [Space]
        _Smoothness0("Smoothness A", Range(0, 1)) = 0.5
        _Smoothness1("Smoothness B", Range(0, 1)) = 0.5
        [Space]
        _Metallic0("Metallic A", Range(0, 1)) = 0.0
        _Metallic1("Metallic B", Range(0, 1)) = 0.0
        [Space]
        _Threshold("Threshold", Range(0, 1)) = 0.1
        _EdgeSmoothing("Edge Smoothing", Range(0, 1)) = 0.2
    ...
    SubShader
    {
        ...
        half _Threshold, _EdgeSmoothing;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            half p = smoothstep(_Threshold, _Threshold + _EdgeSmoothing, v0);  
